...
class DivisiMpkController extends Controller
{
    /**
    ...
    {
        $divisi = Anggota::getJoin()->where('nama_organisasi', 'mpk')
        ->where('divisis.slug', $divisi->slug)
        ->get();
        return view('admin.profil.admin-update-divisi-mpk',[
            "title" => "Data Angkatan",
            "active" => "angkatan",
            "divisi" => $divisi,
        ]);
    ...
    public function update(Request $request, Divisi $divisi)
    {
        ...
        return redirect(URL::to('/admin-mpk/'))
