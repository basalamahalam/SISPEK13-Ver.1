...
<div class="main-content">
    ...
    <main>
        ...
        <div class="btn-box">
            <a href="{{ URL::to('/admin-tambah-anggota-divisi-osis/' . $anggota[0]->slug) }}" class="btn-act">Tambah
                Anggota</a>
        </div>
                ...
                <tbody>
                    ...
                    @foreach ($anggota as $profil)
                        <tr>
                            ...
                            <td class="btn-table">
                                <a href="{{ URL::to('/admin-update-anggota-divisi-osis/' . $profil->id_anggota) }}"
                                    class="btn-update">UPDATE</a><br><br>

                                <form action="/admin-profil-divisi-osis/{{ $profil->id_anggota }}" method="POST"
