...
<div class="main-content">
    ...
    <main>
        <div>
            ...
            /
            <a href="update-divisi-mpk.html" class="link-title">{{ $divisi[0]->nama_divisi }}</a>
        </div>


        <div class="top-card">
            <form action="{{ URL::to('/admin-update-divisi-mpk/' . $divisi[0]->slug) }}" method="post"
                ...
                <div class="form-text">
                    ...
                    @error('deskripsi_divisi')
                        <label for="deskripsi_divisi" style="color: red; font-size: 15px;">
                            <span>
                                {{ $message }}
                            </span>
                        </label>
