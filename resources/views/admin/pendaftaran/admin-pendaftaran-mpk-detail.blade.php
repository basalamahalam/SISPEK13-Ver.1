...
<div class="main-content">
    ...
    <main>
        <div>
            ...
            <!-- LINK -->
            <a href="#" class="dash-title">Pendaftaran</a>
            /
            <a href="{{ URL::to('/admin-pendaftaran-mpk') }}" class="link-title">MPK</a>
            /
            <a href="#" class="link-title">**NAMA PENDAFTAR**</a>
        </div>
        ...
        <div class="btn-box" style="text-align: end;">
            <a href="/admin-pendaftaran-mpk-detail/{{ $detail->id }}/detail-/{{ $detail->pendaftaran }}/{{ $detail->nama }}/pdf"
                class="btn-act">DOWNLOAD PDF</a>
            <a href="{{ URL::to('/admin-pendaftaran-mpk') }}" class="btn-act">KEMBALI</a>
        </div>
